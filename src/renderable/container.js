 ...
 * @ignore
 */
let deferredRemove = function (child, keepalive) {
...
export default class Container extends Renderable {
    ...
    constructor(x, y, width, height) {
        ...
        super(x || 0, y || 0, width || Infinity, height || Infinity);
    ...
    addChildAt(child, index) {
        if (index >= 0 && index < this.children.length) {
            ...
            throw new Error("me.Container: Index (" + index + ") Out Of Bounds for addChildAt()");
        }
    }
    ...
    forEach(callback, thisArg) {
        ...
        if (typeof callback !== "function") {
            throw new Error("me.Container: " + callback + " is not a function");
        }
    ...
    swapChildren(child, child2) {
        ...
        if ((index !== -1) && (index2 !== -1)) {
            ...
            throw new Error("me.Container: " + child + " Both the supplied childs must be a child of the caller " + this);
        }
    }
    ...
    getChildAt(index) {
        if (index >= 0 && index < this.children.length) {
            ...
            throw new Error("me.Container: Index (" + index + ") Out Of Bounds for getChildAt()");
        }
    }
    ...
    removeChild(child, keepalive) {
        if (this.hasChild(child)) {
            ...
            throw new Error("me.Container: Child is not mine.");
        }
    }
