 ...
 * @ignore
 */
let getNewDefaultRenderer = function (obj) {
 ...
 * @ignore
 */
let readLayer = function(map, data, z) {
 ...
 * @ignore
 */
let readImageLayer = function(map, data, z) {
 ...
 * @ignore
 */
let readObjectGroup = function(map, data, z) {
