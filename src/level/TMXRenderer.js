...
export class TMXOrthogonalRenderer extends TMXRenderer {
    ...
    canRender(layer) {
        return (
            (layer.orientation === "orthogonal") && super(layer)
        );
    }
...
export class TMXIsometricRenderer extends TMXRenderer {
    ...
    canRender(layer) {
        return (
            (layer.orientation === "isometric") && super(layer)
        );
    }
...
export class TMXHexagonalRenderer extends TMXRenderer {
    // constructor
    constructor(cols, rows, tilewidth, tileheight, hexsidelength, staggeraxis, staggerindex) {
    ...
    canRender(layer) {
        return (
            (layer.orientation === "hexagonal") && super(layer)
        );
    }
