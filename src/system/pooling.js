...
export function init() {
    ...
    register("me.Entity", me.Entity);
    register("me.CollectableEntity", me.CollectableEntity);
    register("me.LevelEntity", me.LevelEntity);
    register("me.Tween", me.Tween, true);
    register("me.Color", me.Color, true);
    register("me.Particle", me.Particle, true);
    register("me.Sprite", me.Sprite);
    register("me.Vector2d", me.Vector2d, true);
    register("me.Glyph", me.Glyph, true);
    register("me.Matrix2d", me.Matrix2d, true);
};
 ...
 */
 export function register(className, classObj, pooling) {
