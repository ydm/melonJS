 ...
 */
let defaultNormalizeFn = function(value) {
    return value;
}
 ...
 * @ignore
 */
let wiredXbox360NormalizeFn = function(value, axis, button) {
 ...
 * @ignore
 */
let ouyaNormalizeFn = function(value, axis, button) {
    if (value > 0) {
...
let vendorProductRE = /^([0-9a-f]{1,4})-([0-9a-f]{1,4})-/i;
 ...
 * @ignore
 */
let addMapping = function(id, mapping) {
 ...
 * @ignore
 */
let updateGamepads = navigator.getGamepads ? function () {
